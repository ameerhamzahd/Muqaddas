        ...
        <div>
            <div className="hero min-h-screen" style={{ backgroundImage: `url(${notFoundBG})` }}>
                ...
                <motion.div
                    ...
                    className="relative z-10 text-white flex flex-col md:flex-row items-center justify-center gap-8 px-4"
                >
                    {/* 404 Star Icon Style */}
                    <div className="max-w-1/2 md:max-w-1/3 flex items-center justify-center text-6xl md:text-8xl font-bold">
